...
> [!CAUTION]
> Данный плагин является gateway-интерфейсом для взаимодействия с OpenClaw. TrueConf LLC не призывает к использованию OpenClaw, не рекомендует его внедрение в корпоративной инфраструктуре и не несёт ответственности за работу OpenClaw, связанных ИИ-агентов, внешних сервисов или сторонних компонентов.
>
